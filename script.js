...
const renderPage = () => {
  ...
  <div class="wave-divider" aria-hidden="true"><svg viewBox="0 0 1240 60" preserveAspectRatio="none"><path d="M0,30 C200,55 400,5 620,30 C840,55 1040,5 1240,30 L1240,60 L0,60 Z" fill="rgba(212,115,90,0.04)" /><path d="M0,35 C200,60 400,10 620,35 C840,60 1040,10 1240,35 L1240,60 L0,60 Z" fill="rgba(107,142,90,0.04)" /></svg></div>
